...
describe("SqlModule & Global DI", () => {
	...
	test("should perform SQL operations with IN, LIKE, and BETWEEN", async () => {
		...
		await AppStartup.create(OperatorsSqlRootModule);
		const sqlService = new SqlService();
	...
	test("should perform SQL operations with Subqueries and CASE", async () => {
		...
		await AppStartup.create(SubqueriesSqlRootModule);
		const sqlService = new SqlService();
	...
	test("should perform transaction correctly", async () => {
		...
		await AppStartup.create(TransactionSqlRootModule);
		const sqlService = new SqlService();
	...
	test("should rollback transaction on failure", async () => {
		...
		await AppStartup.create(RollbackSqlRootModule);
		const sqlService = new SqlService();

		await sqlService.query(
			"CREATE TABLE products_tx (id INTEGER PRIMARY KEY, name TEXT)",
		);
	...
	test("should perform bulkInsert", async () => {
		...
		await AppStartup.create(BulkInsertSqlRootModule);
		const sqlService = new SqlService();
